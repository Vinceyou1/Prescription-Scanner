  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger asChild>
        <button
          className="w-full flex flex-row items-center justify-between text-lg
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className={dialogStyles.Content}>
          ...
          <Dialog.Title hidden>Login</Dialog.Title>
          <Tabs.Root
          ...
          >
            ...
            <Tabs.Content className={tabStyles.Content} value="tab2">
              <p className={tabStyles.Text}>
                All of your data is encrypted so no one, not even I, can read
                it.
              </p>
              <fieldset className={tabStyles.Fieldset}>
                <label className={tabStyles.Label} htmlFor="email">
